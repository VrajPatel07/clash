...
import { Sparkles, Type, FileText, Calendar, Plus, Image as ImageIcon } from "lucide-react";
...
export default function AddClash() {
    ...
    const submitHandler = async (data: z.infer<typeof clashSchema>) => {
        try {
            ...
            const response = await axios.post("/api/clash", data);
    ...
    const defaultTrigger = (
        <Button className="h-12 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
            Create Clash
        </Button>
    );
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50 border-0 shadow-2xl">
                ...
                <div className="relative">
                    ...
                    <DialogHeader className="text-center mb-6">
                        ...
                        <p className="text-gray-600">Start a new clash and engage your audience</p>
                    </DialogHeader>
                    ...
                    <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 overflow-hidden mb-4">
                        <div className="px-6 pt-6 pb-4">
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-lg font-bold text-gray-800">Clash Details</h3>
                            </div>
                    ...
                    <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 overflow-hidden mb-4">
                        ...
                        <div className="px-6 pt-4 pb-2">
                            ...
                            <p className="text-gray-600 text-xs mb-3">Upload an image to make your clash more engaging</p>
                        </div>
